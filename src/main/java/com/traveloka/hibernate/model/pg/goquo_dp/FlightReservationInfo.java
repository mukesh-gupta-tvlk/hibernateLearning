 ...
 *         &lt;element name="ManagementResponse" type="{http://schemas.datacontract.org/2004/07/GoQuo.DP.Entities}FlightManagementResponseEN" minOccurs="0"/>
 *         &lt;element name="PromoCodes" type="{http://schemas.datacontract.org/2004/07/GoQuo.DP.Entities}ReservationPromoCodesEN" minOccurs="0"/>
...
@XmlType(name = "FlightReservationInfo", namespace = "http://schemas.datacontract.org/2004/07/GoQuo.DP.Entities", propOrder = {
...
public class FlightReservationInfo {
    ...
    @XmlElementRef(name = "ManagementResponse", namespace = "http://schemas.datacontract.org/2004/07/GoQuo.DP.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<FlightManagementResponseEN> managementResponse;
    @XmlElementRef(name = "PromoCodes", namespace = "http://schemas.datacontract.org/2004/07/GoQuo.DP.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<ReservationPromoCodesEN> promoCodes;
    ...
    /**
     * Gets the value of the managementResponse property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link FlightManagementResponseEN }{@code >}
     *     
     */
    public JAXBElement<FlightManagementResponseEN> getManagementResponse() {
        return managementResponse;
    }

    /**
     * Sets the value of the managementResponse property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link FlightManagementResponseEN }{@code >}
     *     
     */
    public void setManagementResponse(JAXBElement<FlightManagementResponseEN> value) {
        this.managementResponse = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ReservationPromoCodesEN }{@code >}
     *     
     */
    public JAXBElement<ReservationPromoCodesEN> getPromoCodes() {
        return promoCodes;
    }
     ...
     *     
     */
    public void setPromoCodes(JAXBElement<ReservationPromoCodesEN> value) {
