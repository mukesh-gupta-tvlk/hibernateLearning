...
@XmlType(name = "FlightSearchReponse", propOrder = {
    "availableFlights",
...
public class FlightSearchReponse {
    ...
    @XmlElementRef(name = "AvailableFreeBaggages", namespace = "http://schemas.datacontract.org/2004/07/GoQuo.DP.BAL", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfBaggages> availableFreeBaggages;
    ...
    /**
     * Gets the value of the availableFreeBaggages property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfBaggages }{@code >}
     *     
     */
    public JAXBElement<ArrayOfBaggages> getAvailableFreeBaggages() {
        return availableFreeBaggages;
    }

    /**
     * Sets the value of the availableFreeBaggages property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfBaggages }{@code >}
     *     
     */
    public void setAvailableFreeBaggages(JAXBElement<ArrayOfBaggages> value) {
        this.availableFreeBaggages = value;
    }
