...
public class Message {
    ...
    @XmlElementRef(name = "Code", namespace = "http://schemas.datacontract.org/2004/07/GoQuo.DP.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<String> code;
    @XmlElement(name = "IsSuccess")
    protected Boolean isSuccess;
    @XmlElementRef(name = "MessageText", namespace = "http://schemas.datacontract.org/2004/07/GoQuo.DP.Entities", type = JAXBElement.class, required = false)
