...
public class MobileAppLangTextEN {
    ...
    @XmlElementRef(name = "ControlName", namespace = "http://schemas.datacontract.org/2004/07/GoQuo.DP.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<String> controlName;
    @XmlElementRef(name = "ControlText", namespace = "http://schemas.datacontract.org/2004/07/GoQuo.DP.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<String> controlText;
     ...
     *     
     */
    public JAXBElement<String> getControlName() {
        return controlName;
    }
     ...
     *     
     */
    public void setControlName(JAXBElement<String> value) {
        this.controlName = value;
    }

    /**
     * Gets the value of the controlText property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getControlText() {
        return controlText;
    }

    /**
     * Sets the value of the controlText property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setControlText(JAXBElement<String> value) {
