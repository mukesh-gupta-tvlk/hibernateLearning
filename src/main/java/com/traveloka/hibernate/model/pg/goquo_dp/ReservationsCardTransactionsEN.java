 ...
 *         &lt;element name="MandiriDebitcardNo" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="MandiriToken" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "ReservationsCardTransactionsEN", namespace = "http://schemas.datacontract.org/2004/07/GoQuo.DP.Entities", propOrder = {
    "approvalCode",
    "bankName",
    "cardID",
    "cardTransactionID",
...
public class ReservationsCardTransactionsEN {
    ...
    @XmlElementRef(name = "MandiriDebitcardNo", namespace = "http://schemas.datacontract.org/2004/07/GoQuo.DP.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<String> mandiriDebitcardNo;
    @XmlElementRef(name = "MandiriToken", namespace = "http://schemas.datacontract.org/2004/07/GoQuo.DP.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<String> mandiriToken;
    ...
    /**
     * Gets the value of the mandiriDebitcardNo property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getMandiriDebitcardNo() {
        return mandiriDebitcardNo;
    }

    /**
     * Sets the value of the mandiriDebitcardNo property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setMandiriDebitcardNo(JAXBElement<String> value) {
        this.mandiriDebitcardNo = value;
    }

    /**
     * Gets the value of the mandiriToken property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getMandiriToken() {
        return mandiriToken;
    }

    /**
     * Sets the value of the mandiriToken property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setMandiriToken(JAXBElement<String> value) {
        this.mandiriToken = value;
    }
