...
public class SpecialService {
    ...
    @XmlElementRef(name = "CommercialCode", namespace = "http://schemas.datacontract.org/2004/07/GoQuo.DP.BAL", type = JAXBElement.class, required = false)
    protected JAXBElement<String> commercialCode;
    @XmlElementRef(name = "CommercialName", namespace = "http://schemas.datacontract.org/2004/07/GoQuo.DP.BAL", type = JAXBElement.class, required = false)
